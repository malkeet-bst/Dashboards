...
class BellNotification extends React.Component {
  ...
  nextClick = (view) => {
    if (document.getElementById('notificationMode').checked) {
      console.log(document.getElementById('notificationMode').value);
    }
      ...
      <If condition={currentView === "home"}>
        <form>
          ...
          <div className="form-group required">
            ...
            <div className="col-sm-6">
              <input type="text" onChange={this.updatevalue.bind(this, "cta_title")} className="form-control" />
            </div>
            <br />
          </div>
          <div className="form-group required">
            ...
            <div className="col-sm-6">
              <select className="form-control" id="click_action_type" onChange={this.updatevalue.bind(this, "priority")} name="priority" required>
            ...
            <div id="notificationMode" className="col-sm-6">
              <label class="radio-inline">
                <input type="radio" name="site_name"
                  value="ribbon"
                  checked={this.state.mode === 'ribbon'}
                  onChange={() => this.onModeChanged('ribbon')} />Ribbon
                </label>
              <label class="radio-inline">
                <input type="radio" name="site_name"
                  value="sticky"
                  checked={this.state.mode === 'sticky'}
                  onChange={() => this.onModeChanged('sticky')} />Sticky
                </label>
              <label class="radio-inline">
                <input type="radio" name="site_name"
                  value="both"
                  checked={this.state.mode === 'both'}
          ...
          <div className="form-group required">
            ...
            <div className="col-sm-6">
              <input type="text" onChange={this.updatevalue.bind(this, "action_value")} className="form-control" />
            </div>
            <br />
          </div>
          <div className="form-group required">
            ...
            <div className="col-sm-6">
              <input type="text" onChange={this.updatevalue.bind(this, "action_id")} className="form-control" />
            </div>
            <br />
          </div>
          <div className="form-group required">
            ...
            <div className="col-sm-6">
              <input type="text" className="form-control" onChange={this.updatevalue.bind(this, "image_url")} />
            ...
            <div className="form-group required">
              ...
              <div className="col-sm-6">
                <input type="text" onChange={this.updatevalue.bind(this, "package_name")} className="form-control" />
              </div>
              <br />
            </div>
            <div className="col-sm-3">
