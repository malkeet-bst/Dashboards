...
const tooltipText = (
  <div>
    ...
    <br />
    #installedapp_com.supercell.clashofclans : clashofclans is installed <br />{" "}
    #pikapoints-current_1000_9999999999 : current pika points min 1000 max
    9999999999 <br />
    #pikapoints-alltime_1000_9999999999 : alltime pika points min 1000 max
    9999999999 <br /> #age-day_0_0: Show on Day0 of User
    <br />
    #age-day_1_999: Show from Day1 to Day999 of User <br />
    #email_present: Show if email present. <br /> #email_absent: Show if email
    absent. <br /> #premium_user_present: Show to premium users <br />{" "}
...
class Audience extends React.Component {
  ...
  componentDidMount = () => {
    ...
    if (copyData) {
      ...
      //validity: [moment(copyData.campaign_start_time),moment(copyData.campaign_end_time)]
      if (copyData.campaign_start_time) {
        this.setState({
          startTime: copyData.campaign_start_time,
          endTime: copyData.campaign_end_time,
  ...
  publishCamp = () => {
    let { audienceType, audience, startTime, endTime } = this.state;
    if (audienceType === "filters") {
      if (!audience) {
        this.setState({ apiStatus: { error: "Enter audience and validity" } });
      } else if (!startTime || !endTime) {
        this.setState({
          apiStatus: {
            error: "Start and end date are mandatory for creating filter"
          }
        });
      } else {
      ...
      if (fileInput && fileInput.files[0]) {
        ...
        reader.onload = () => {
          ...
          GlobalActions.publishCampaign(audienceType, JSON.stringify(csv_data));
        };
      } else {
  ...
  render() {
    ...
    if (cloneData && cloneData.campaign_start_time) {
    defaultStartTime = moment(cloneData.campaign_start_time);
    defaultEndTime = moment(cloneData.campaign_end_time);
    }
    return (
      <div id="audience">
        ...
        <section>
          ...
          <div style={{ textAlign: "center", marginBottom: "20px" }}>
            ...
            <label className="radio-inline">
              <input
                ...
                name="site_name"
                value="ribbon"
                checked={audienceType === "filters"}
                onChange={() => this.onModeChanged("filters")}
              />
              Enter Audience
            </label>
            <label className="radio-inline">
              <input
                ...
                name="site_name"
                value="sticky"
                checked={audienceType === "guid"}
                onChange={() => this.onModeChanged("guid")}
              />
              Upload Guids
            </label>
          </div>
          <form className="form-horizontal">
            <If condition={audienceType === "filters"}>
              <div className="form-group required">
                ...
                <div className="col-sm-6">
                  ...
                  <button
                    ...
                    onClick={() => this.onShowFilter(true)}
                  >
                    Filter ?
                  </button>
                </div>
              ...
              <Modal
                title="HashTags Examples"
                visible={showFilters}
                centered
                maskClosable={true}
                footer={null}
                onCancel={() => this.onShowFilter(false)}
              >
                      ...
                      <tr>
                        ...
                        <td id="john1">
                          <button
                            ...
                            type="button"
                            onClick={() =>
                              this.copyToClipBoard("#country_US_CA")
                            }
                          >
                            <span
                          ...
                          <button
                            ...
                            onClick={() =>
                              this.copyToClipBoard(
                                "#installedapp_com.supercell.clashofclans"
                              )
                            }
                          >
                            <span
                      ...
                      <tr>
                        ...
                        <td id="john1">
                          <button
                            ...
                            onClick={() =>
                              this.copyToClipBoard(
                                "#pikapoints-current_1000_9999999999"
                              )
                            }
                          >
                            <span
                      ...
                      <tr>
                        ...
                        <td id="john1">
                          <button
                            ...
                            onClick={() =>
                              this.copyToClipBoard(
                                "#pikapoints-alltime_1000_9999999999"
                              )
                            }
                          >
                            <span
                      ...
                      <tr>
                        ...
                        <td id="john1">
                          <button
                            className="btn btn-link"
                            type="button"
                            onClick={() => this.copyToClipBoard("#age-day_0_0")}
                          >
                            <span
                              className="glyphicon glyphicon-copy"
                              aria-hidden="true"
                      ...
                      <tr>
                        ...
                        <td id="john1">
                          <button
                            ...
                            type="button"
                            onClick={() =>
                              this.copyToClipBoard("#age-day_1_999")
                            }
                          >
                            <span
                              className="glyphicon glyphicon-copy"
                      ...
                      <tr>
                        ...
                        <td id="john1">
                          <button
                            ...
                            type="button"
                            onClick={() =>
                              this.copyToClipBoard("#email_present")
                            }
                          >
                            <span
                              className="glyphicon glyphicon-copy"
                      ...
                      <tr>
                        ...
                        <td id="john1">
                          <button
                            ...
                            type="button"
                            onClick={() =>
                              this.copyToClipBoard("#email_absent")
                            }
                          >
                            <span
                              className="glyphicon glyphicon-copy"
                      ...
                      <tr>
                        ...
                        <td id="john1">
                          <button
                            ...
                            type="button"
                            onClick={() =>
                              this.copyToClipBoard("#premium_user_present")
                            }
                          >
                            <span
                              className="glyphicon glyphicon-copy"
                      ...
                      <tr>
                        ...
                        <td id="john1">
                          <button
                            ...
                            type="button"
                            onClick={() =>
                              this.copyToClipBoard("#premium_user_absent")
                            }
                          >
                            <span
                              className="glyphicon glyphicon-copy"
            ...
            <If condition={apiStatus == "" || apiStatus.error}>
              <ButtonBar
                nextString="Send"
                backClick={this.changeTab}
                saveClick={this.saveDraft}
                nextClick={() => this.sendClick("audience")}
              />
            </If>
          </form>
        </section>
